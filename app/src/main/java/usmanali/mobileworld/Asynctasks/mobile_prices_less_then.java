...
public class mobile_prices_less_then extends AsyncTask<String,Void,Void> {
    String mobile_price;
    ArrayList<mobiles> mobileslist;

    public mobile_prices_less_then(Context context, RecyclerView mobilesrv) {
    ...
    protected Void doInBackground(String... strings) {
        ...
        try {
            URL url=new URL("https://ameboid-snaps.000webhostapp.com/mobile_prices_less_then.php");
